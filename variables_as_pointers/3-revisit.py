...
#my answer:
'''
Holy Grail gets printed.
reason: dict2 is a shallow copy of dict1, meaning nested dicts are just references to the original dict key-values. In this case, dict2['Monty Python']'s assignment will reference and reassign dict1['Monty Python'] to a different value. 
...
# PJ comment: my mistake was assuming the constructor would create a nested dict.
